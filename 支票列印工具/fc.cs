...
namespace 支票列印工具
{
    public class fc
    {
        ...
        public static string WRDIR = MyDocumentsPath + "\\CheckPrints";
        public static string NodeSoftWare = "Software";
        public static string NodeWR = "CheckPrints";
        public static string NodePath = @"HKEY_CURRENT_USER\Software\" + NodeWR;
        public static string INIPath = MyDocumentsPath + "\\CheckPrints\\Config.ini"; 
